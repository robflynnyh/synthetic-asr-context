...
#model_name = "/store/store4/data/huggingface_models/models--Qwen--Qwen2.5-0.5B-Instruct/snapshots/7ae557604adf67be50417f59c2c2f167def9a775"
#model_name = "/store/store5/data/acp21rjf_checkpoints/synctxasr/grpo/checkpoint-1000/"
model_name = "/store/store4/data/huggingface_models/models--meta-llama--Llama-3.2-1B-Instruct/snapshots/9213176726f574b556790deb65791e0c5aa438b6    "
...
messages = [
    ...
    {"role": "user", "content": "'buti was so utterly unqualified for this project and so utterly ridic and ignored the brief'."},
]
...
response = outputs[0].split('<|eot_id|><|start_header_id|>assistant<|end_header_id|>')[-1].strip().split('<|eot_id|>')[0].strip()
